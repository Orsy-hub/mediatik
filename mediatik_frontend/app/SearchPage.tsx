...
import { Search, Heart, Plus, X, Music, User, Album, Mic } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-white text-gray-800 flex flex-col">
      ...
      <div className="bg-white shadow-sm p-4 flex items-center gap-3">
        ...
        <div className="flex-1 relative">
          <input
            ...
            className="w-full p-2 pl-10 pr-8 bg-gray-100 rounded-full text-sm focus:outline-none"
          />
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <section className="mb-6">
          <h2 className="text-pink-500 font-bold text-lg mb-4">Explorer</h2>
          <div className="grid grid-cols-2 gap-3">
            {categories.map(category => (
              <div key={category.id} className="bg-white rounded-xl p-3 shadow-sm flex items-center gap-3">
        ...
        <section>
          <h2 className="text-pink-500 font-bold text-lg mb-4">Écoutés récemment</h2>
          <div className="space-y-2">
            {recentSearches.map(search => (
              <div key={search.id} className="flex items-center justify-between p-3 bg-white rounded-xl shadow-sm">
